...
public class TestGenericResourceApi extends AbstractDataBrokerTest {
	...
	protected void setupWithDataBroker(DataBroker dataBroker) {
		...
		genericResourceApiProvider = new GenericResourceApiProvider(dataBroker, mockNotification, rpcProviderRegistry);
		genericResourceApiProvider.setDataBroker(dataBroker);
		genericResourceApiProvider.setNotificationService( mockNotification );
	}
